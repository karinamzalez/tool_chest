...
RSpec.feature "Tool management", type: :feature do
  scenario "user creates a new tool" do
    # visit a page with the form to create a new tools
    visit new_tool_path
    # fill in the tools attribute: name, price, quantity
    ...
    # check and make sure all of the attribute I filled in and submitted are displaying on the page
